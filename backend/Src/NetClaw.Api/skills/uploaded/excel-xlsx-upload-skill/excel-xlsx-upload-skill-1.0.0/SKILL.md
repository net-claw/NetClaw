---
name: Excel / XLSX Upload Skill
slug: excel-xlsx-upload
version: 1.0.0
homepage: https://clawic.com/skills/excel-xlsx-upload
description: "Upload-test variant of the Excel/XLSX skill for NetClaw. Create, inspect, and edit Microsoft Excel workbooks and XLSX files with reliable formulas, dates, types, formatting, recalculation, and template preservation."
...
This local repo also includes an executable example for sandbox testing:

- Install deps: `pip3 install -r /skills/test/excel-xlsx-1.0.2/requirements.txt --break-system-packages`
- Create workbook:
  `python3 /skills/test/excel-xlsx-1.0.2/scripts/create_workbook.py --output /workspace/downloads/example.xlsx --title "Example Export" --json '{"headers":["Name","Email","Score"],"rows":[["Alice","alice@example.com",91],["Bob","bob@example.com",88]]}'`

The script creates a workbook with a formatted header row, sample data rows, a simple average formula, and a metadata sheet.

## Feedback

- If useful: `clawhub star excel-xlsx-upload`
